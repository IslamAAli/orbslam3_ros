...
namespace CARV_HELPERS
{
    cv::Mat se3ToCvMat(const Sophus::SE3<float>& se3) {
        std::cout << "Called se3ToCvMat " << std::endl;
        ...
        std::cout << "Return se3ToCvMat : " << cvTransform << std::endl;
        return cvTransform;
    }

    cv::Mat vector3fToCvMat(const Eigen::Vector3f& vector) {
        std::cout << "Called vector3fToCvMat " << std::endl;
        ...
        std::cout << "Return vector3fToCvMat : " << cvMat << std::endl;
        return cvMat;
    }

    Eigen::Vector3f matToEigenVector3f(const cv::Mat& mat) {
        std::cout << "Called matToEigenVector3f " << std::endl;
        ...
        std::cout << "Return matToEigenVector3f : " << cvMat << std::endl;
        return eigenVec;
    }
}
